...
9.  **PARAGRAPH DETECTION**: Remove unnecessary line breaks, fragmented words, and layout-only text breaks. Use real paragraph cues from the source, especially indentation at the beginning of a paragraph, to decide when a new paragraph actually starts.
10. **MULTI-COLUMN READING ORDER**: If the page contains multiple columns, process one full column at a time from left to right. Never read horizontally across the entire page width.
